...
@router.get("/",status_code=status.HTTP_200_OK,response_model=list[schema.show_customers])
...
@router.get("/{id}",status_code=status.HTTP_200_OK,response_model=schema.show_customers)
...
@router.put("/{id}",status_code=status.HTTP_200_OK,response_model=schema.show_customers)
